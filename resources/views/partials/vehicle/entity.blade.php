                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-sm-flex justify-content-between align-items-center" >
                                        ...
                                        <button class="btn btn-warning py-2 mb-sm-0 mb-2" data-bs-toggle="modal" data-bs-target="{{ $entity == 'shape' ? '#vehicleShapeModal' : ($entity == 'category' ? '#vehicleCategoryModal' : '#vehicleFeatureModal') }}">
